...
void WhileStmt::genCode()
{
    ...
    builder->setWhileContentStmt(stmt);
    stmt->genCode();
    backPatch(stmt->trueList(), while_bb);
    backPatch(stmt->falseList(), end_bb);
    while_bb = builder->getInsertBB();

    new UncondBrInstruction(while_bb, while_bb);
...
void BreakStmt::genCode()
{
    ...
    Function *func = bb->getParent();
    BasicBlock* tempBB = new BasicBlock(func);
    builder->getWhileContentStmt()->falseList().push_back(new UncondBrInstruction(bb, tempBB));
}
...
void ContinueStmt::genCode()
{
    ...
    Function *func = bb->getParent();
    BasicBlock* tempBB = new BasicBlock(func);
    builder->getWhileContentStmt()->trueList().push_back(new UncondBrInstruction(bb, tempBB));
}
