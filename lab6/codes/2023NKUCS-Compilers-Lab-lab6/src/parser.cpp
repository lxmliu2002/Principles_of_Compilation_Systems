...
{
       0,    65,    65,    70,    71,    76,    77,    78,    79,    80,
      81,    82,    87,    92,    93,    94,    97,   105,   115,   120,
     125,   130,   130,   140,   145,   148,   153,   153,   168,   173,
     178,   181,   192,   196,   199,   202,   205,   217,   221,   227,
     228,   235,   246,   247,   253,   270,   271,   284,   297,   309,
     310,   320,   332,   335,   340,   345,   350,   357,   358,   363,
     370,   371,   378,   379,   386,   389,   390,   395,   399,   402,
     408,   409,   412,   415,   420,   424,   427,   431,   434,   442,
     467,   482,   482,   516,   542,   542,   585,   588,   594,   648,
     670,   670,   708,   763,   785,   785,   822,   825,   830,   833,
     838,   843,   838,   870,   871,   873,   877,   882,   891,   917,
     920
};
#endif
...
#line 253 "src/parser.y"
        ...
        if ((yyvsp[0].exprtype)->getType()->isFloat()) {
            ...
            SymbolEntry* zero = new ConstantSymbolEntry(TypeSystem::constFloatType, 0);
            SymbolEntry* temp = new TemporarySymbolEntry(TypeSystem::boolType, SymbolTable::getLabel());
            BinaryExpr* cmpZero = new BinaryExpr(temp, BinaryExpr::NOTEQUAL, (yyvsp[0].exprtype), new Constant(zero));
...
#line 2636 "src/parser.cpp"
    break;


#line 2640 "src/parser.cpp"
